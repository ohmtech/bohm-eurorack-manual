...
is typically used at home or in the studio.
No menu diving, and every change of parameter is instant.
...
- With the **Latch** `LAT` option, the parameter value will "jump" to the knob position as soon as the knob is slightly turned
